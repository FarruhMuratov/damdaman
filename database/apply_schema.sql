-- Скрипт для применения схемы базы данных Damdaman Tour Platform
-- Выполните этот файл в вашей PostgreSQL базе данных на Railway
...
SELECT 'Схема базы данных успешно применена!' as status;

-- Показываем созданные таблицы
SELECT table_name, 'таблица' as type
